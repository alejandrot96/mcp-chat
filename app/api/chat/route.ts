...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    system:
    `You are a dedicated and obedient assistant that can browse the web. You are given instructions that you will follow precisely and completely. You may need to browse the web to find answers, or you may already know them.
